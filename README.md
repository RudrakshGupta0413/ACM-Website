...
First go through the complete codebase, understnd it and then try to implement your ideas.
Each of u should maintain an individual branch of your own names or u can do one more thing, make branches according to thefeatures/fixes/etc.
